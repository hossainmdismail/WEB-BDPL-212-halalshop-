...
class CustomerController extends Controller
{
    ...
    public function order_save(Request $request)
    {
        ...
        if ($recentOrder) {
            return back()->with('error', '❗ দুঃখিত! আপনার একটি অর্ডার ইতিমধ্যে চলমান আছে।
ওই অর্ডারটি সম্পন্ন না হওয়া পর্যন্ত একই তথ্য দিয়ে নতুন অর্ডার করা যাবে না।
কোনো সহায়তা প্রয়োজন হলে আমাদের হোয়াটসঅ্যাপ অথাবা ইনবক্স করুন।');
        }
    ...
    private function sendOrderSms(string $phone, string $name): void
    {
        $site_setting = GeneralSetting::where('status', 1)->first();
    ...
    //     if ($recentOrder) {
    //         return back()->with('error', 'You already placed an order recently. Please try again later.');
    //     }
